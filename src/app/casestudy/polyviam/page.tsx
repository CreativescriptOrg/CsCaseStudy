...
import data from "@/json/polyviam.json";
...
export default function Polyviam() {
	...
	return (
		<div style={{ "--theme-color": data.theme_color } as React.CSSProperties}>
			<Header />
			<Hero data={hero} />
			<About data={about} about_grid='' />
			<ProjectTeam data={projectTeam} />

			<ProjectDetailsSection data={data.projectDetails_1} />

			<div className='container polyviam_mockup_grid mockup_grid'>
